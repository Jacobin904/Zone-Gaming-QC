...
async function registerCommands() {
    const commands = [
        ...
        { name: 'setup', description: 'Envoyer un embed de configuration (choisir une option)', options: [
